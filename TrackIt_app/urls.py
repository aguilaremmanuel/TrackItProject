...
urlpatterns = [
    ...
    path('director-needs-action/',views.director_needs_action, name='director_needs_action'),
    ...
    path('action-officer-records/',views.action_officer_records, name='action_officer_records'),
