document.addEventListener('DOMContentLoaded', function() {
    ...
    document.getElementById('printQR').addEventListener('click', async function() {
        ...
        printWindow.document.write('body, html { font-family: Inter, sans-serif; text-align: center; margin: 0 !important; padding: 0 !important; }');
        printWindow.document.write('img { max-width: 28mm;}');
        printWindow.document.write('p { font-size: 13px; font-weight: bold; margin: 0; padding: 0; }');
        printWindow.document.write('@media print { body, html { margin: 0 !important; padding: 0 !important; } }');
        printWindow.document.write('</style>');
        printWindow.document.write('</head><body>');;    
        printWindow.document.write('<div style="width: 165px; display: flex; flex-direction: column; align-items: center;">');
        printWindow.document.write('<p>' + routesInitials + '</p>');
        printWindow.document.write('<p style="font-size: 8px; font-weight: 400">'+ routesTitles +'</p>');
        printWindow.document.write('<img id="qrCodeImage" src="' + url + '" />');
        printWindow.document.write('<p style="font-size: 11px;">' + trackingNo + '</p>');
