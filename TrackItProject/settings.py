...
SECRET_KEY = 'django-insecure-@513anuuj%8rkn2xs-z%29u1wu+i+i=u+i0ne^v-5woum%s@9s'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = [ 'www.trackitdts.online', 'trackitdts.online', 'locahost']
...
ROOT_URLCONF = 'TrackItProject.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [os.path.join(BASE_DIR, 'templates')],  # Include your global templates folder
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
